...
<small>
```{r remedy008}
animals_fac <- as.factor(more_animals)
class(animals_fac)
levels(animals_fac)
...
<small>
```{r}
animals_fac2 <- factor(animals_fac,
                       levels = c("dog", "cat", "rat", "mouse"))

animals_fac
animals_fac2 # after re-ordering
```
...
<small>
```{r remedy009}
animals_back <- as.character(animals_fac)
identical(more_animals, animals_back)
```
